...
public class BabyNamesBudhism {
    ...
    public void babyNameList() throws TimeoutException {
        try {
            ...
            driver.get("https://www.momjunction.com/baby-names/buddhism/page/9/");
            ...
            convertAndWriteToJson(nameDetailsList, "babyNamesBuddhismTwo.json");
        } catch (Exception e) {
